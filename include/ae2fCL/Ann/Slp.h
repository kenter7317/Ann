...
/// Array of weights in a count of [inputsCount] for [ae2fCL_AnnSlp::mgWeight]. \n
/// Passing this argument zero will cause [ae2fCL_AnnSlp::mgWeight] to be randomised.
/// @param inputsCount
...
/// @see ae2fCL_AnnSlpPredictA
/// @see ae2fCL_AnnSlpPredictB
/// 
/// @param[in] _this 
/// @param[in] in 
/// The input value binded with an OpenCL memory object. \n
/// If you don't want to make a memory object manually, see [ae2fCL_AnnSlpPredictBuffAuto].
/// 
...
/// 
/// @param[in] _this [const ae2fCL_AnnSlp*]
/// @param[in] in [cl_mem]
/// The input value binded with an OpenCL memory object. \n
/// If you don't want to make a memory object manually, see [ae2fCL_AnnSlpPredictBuffAuto].
/// 
