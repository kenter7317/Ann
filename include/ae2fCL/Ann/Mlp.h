 ...
 *
 * */
ae2f_extern ae2f_SHAREDCALL size_t ae2fCL_AnnMlpInit(
    ae2f_mAnnMlp *_this, size_t layerc, size_t add_opt, const size_t *layerlenv,
    const size_t *layerpadv_opt_unused, const size_t *inpadv_opt,
    const ae2f_fpAnnAct_t *actv_opt, const ae2f_fpAnnAct_t *act_deriv_v_opt,
    const ae2f_fpAnnLoss_t *lossderiv_v_opt, ae2f_float_t *weights_opt,
    ae2f_err_t *errret_opt, cl_int *errnfound_opt) noexcept;
 ...
 * as it seem.
 * */
ae2f_extern ae2f_SHAREDCALL ae2f_AnnMlp *ae2fCL_AnnMlpMk(
    size_t layerc, size_t add_opt, const size_t *layerlenv,
    const size_t *layerpadv_opt, const size_t *inpadv_opt,
    const ae2f_fpAnnAct_t *actv_opt, const ae2f_fpAnnAct_t *act_deriv_v_opt,
    const ae2f_fpAnnLoss_t *lossderiv_v_opt, ae2f_float_t *weights_opt,
    ae2f_err_t *errret_opt, cl_int *errnfound_op) noexcept;
