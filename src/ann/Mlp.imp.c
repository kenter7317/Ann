...
ae2f_SHAREDEXPORT void ae2f_AnnMlpMk(
		ae2f_err_t* ae2f_restrict const		reterr
		, ae2f_AnnMlp* ae2f_restrict* ae2f_restrict const	retmk

		, const size_t				depth
		, const size_t* ae2f_restrict const		szvector
		, ae2f_opt size_t* ae2f_restrict const	szswap_opt

		, ae2f_opt ae2f_AnnAct_t** ae2f_restrict const	act
		, ae2f_opt ae2f_AnnAct_t** ae2f_restrict const	actderiv
		, ae2f_AnnLoss_t* const			lossderiv

		, ae2f_opt ae2f_float_t* ae2f_restrict const	deltastream
		, ae2f_opt ae2f_float_t* ae2f_restrict const	outcache
		, ae2f_opt ae2f_float_t* ae2f_restrict const	weight
		, ae2f_opt ae2f_float_t* ae2f_restrict const	bias
...
ae2f_SHAREDEXPORT void ae2f_AnnMlpPredict(
		...
		, const ae2f_float_t* ae2f_restrict const	inp
...
ae2f_SHAREDEXPORT void ae2f_AnnMlpTrain(
		...
		, const ae2f_float_t* ae2f_restrict const	inp
		, ae2f_float_t* ae2f_restrict const		out
		, const ae2f_float_t* ae2f_restrict const	out_desired
		) ae2f_noexcept {
