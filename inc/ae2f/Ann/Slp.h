...
#define __ae2f_AnnSlpMk_imp( \
 ...
 \
	/** param */ \
		...
		/*     const size_t */ outc, \
		/*     const size_t */ offset_opt, \
		/*       ae2f_optae2f_AnnAct_t*  const */ act, \
		/*     ae2f_optae2f_AnnAct_t*  const */ actderiv, \
		/*    ae2f_AnnLoss_t*  const */ lossderiv, \
		/*      ae2f_float_t */ learningrate, \
		/*     ae2f_float_t    */ learningrate_bias \
) \
...
#define __ae2f_AnnSlpMk( \
 ...
 \
	/** param */ \
		...
		/*        ae2f_float_t */ learningrate, \
		/*       ae2f_float_t */ learningrate_bias, \
		/*      ae2f_optae2f_err_t*  const    */ err_opt \
)  \
{ \
	if((err_opt) && *(err_opt)) \
		; \
...
#define __ae2f_AnnSlpPredict_imp( \
	/** tparam */ \
		 \
 \
	/** param */ \
		...
		/*   constae2f_float_t*  const    */ prm_in, \
		/*  ae2f_float_t*  const    */ out, \
...
#define __ae2f_AnnSlpPredict( \
	/** tparam */ \
		 \
 \
	/** param */ \
		/*    ,ae2f_err_t*  const    */ err_opt, \
		/*   constae2f_AnnSlp_t*  const    */ _this, \
		/*   constae2f_float_t*  const    */ prm_in, \
		/*  ae2f_float_t*  const     */ out, \
		/*   constae2f_float_t*  const    */ weight, \
		/*   constae2f_float_t*  const    */ bias, \
...
#define __ae2f_AnnSlpFollowSingle_imp( \
	/** tparam */ \
		 \
 \
	/** param */ \
		/*    , ae2f_AnnSlpFollowSingle_t    */ v_follow, \
		/*   constae2f_float_t*     */ prm_in, \
...
#define __ae2f_AnnSlpFollow_imp( \
	/** tparam */ \
		 \
 \
	/** param */ \
...
#define __ae2f_AnnSlpFetchDelta_imp( \
	/** tparam */ \
		 \
 \
	/** param */ \
...
#define __ae2f_AnnSlpFetchDelta( \
	/** tparam */ \
		 \
 \
	/** param */ \
		/*    , ae2f_optae2f_err_t*  const    */ err, \
		/*   constae2f_AnnSlp_t*  const     */ slp, \
		/*   constae2f_float_t*  const    */ out, \
		/*   constae2f_float_t*  const     */ out_desired, \
		/*     ae2f_AnnAct_t    */ actderiv_opt, \
		/*    ae2f_AnnLoss_t     */ lossderiv, \
...
#define __ae2f_AnnSlpFit( \
	/** tparam */ \
		 \
 \
	/** param */ \
		/*    ,ae2f_err_t*  const ae2f_opt    */ reterr_opt, \
		/*   constae2f_AnnSlp_t*      */ _this, \
		/*   constae2f_float_t*  const    */ prm_inp, \
		/*   constae2f_float_t*  const    */ prm_out, \
		/*   constae2f_float_t*  const     */ prm_out_desired, \
		/*  ae2f_float_t*   const    */ weights, \
		/*  ae2f_float_t*   const    */ bias, \
		/*  ae2f_float_t*    const     */ cachedelta, \
...
#define __ae2f_AnnSlpTrain_C( \
 ...
 \
	/** param */ \
		/*    ,ae2f_err_t*  const    */ err, \
		/*  ae2f_AnnSlp*      */ slp, \
		/*   constae2f_float_t*     */ inp, \
		/*   constae2f_float_t*     */ out_desired \
) \
{ \
	unless(slp) \
		(err) && (*(err) |= ae2f_errGlob_PTR_IS_NULL); \
